<template>
  <div>
    <love-dialog
      ...
      :height="420"
    >
      <div class="title-tip">设置新闻</div>
      <div class="change-ps-input" style="margin-top: 80px">
        <span class="role-tip">内容：</span>
        <el-input class="input-box" type="text" v-model="params.content" placeholder="请输入内容" />
...
import { getAdminRole, addNews, updateNews } from "@/api/baseSetting";
export default {
  components: {
    LoveDialog
  },
