<template>
  <div class="app-container">
    <el-card class="layout-title" shadow="never">
      ...
      <span style="margin-top: 5px">会员状态</span>
...
<!--        </el-table-column>-->
        ...
        <el-table-column label="头像" align="center">
          <template slot-scope="scope"> <img v-if="scope.row.avatarUrl"   :src="scope.row.avatarUrl"  style="width: 40px;
  height: 40px;
...
<!--        </el-table-column>-->
        <el-table-column label="到期时间" align="center">
          <template slot-scope="scope"><div v-if="scope.row.edate" style="color:red">黄金会员({{scope.row.edate|time}})</div>
            <div v-if="!scope.row.edate" >普通会员</div>
          </template>
        </el-table-column>
...
import { getMemberStatus } from "@/api/userInfo";
