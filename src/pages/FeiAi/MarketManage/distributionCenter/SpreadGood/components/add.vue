  ...
  <div>
    ...
    >
      ...
      <div class="change-ps-input" style="border: none">
        ...
        <el-select v-model="params.roleId" size="small" placeholder="请选择" class="input-box">
      ...
      <div class="change-ps-input-list" style="position: relative">
        ...
        <div style="display: flex;flex-wrap: wrap" class="input-box">
          <div class="clickTrue" style="display: flex;margin-bottom: 2px"  v-for="(item,index) in params.goodImgList" :key="index"  closable >
      ...
      <div class="change-ps-input-list" style="position: relative">
        ...
        <div style="display: flex;flex-wrap: wrap" class="input-box">
          <div class="clickTrue" style="display: flex;margin-bottom: 2px"  v-for="(item,index) in params.playImgList" :key="index"  closable >
            <img :src="item"  alt="" width="20" height="20" >
            <!--          {{item.name}}-->
...
export default {
  ...
  methods: {
    ...
    saveSetting() {
      if (this.params.id) {
        ...
        //添加
        this.params.Showimg=this.params.playImgList.toString()
        this.params.Details=this.params.goodImgList.toString()
        addGood(this.params).then(res => {
          if (res.code === 0) {
  ...
  created() {
    ...
    if (this.contentList.id) {
      getGoodDetail(this.contentList.id).then(res=>{
